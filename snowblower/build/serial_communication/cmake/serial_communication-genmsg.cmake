...
message(STATUS "serial_communication: 1 messages, 0 services")

set(MSG_I_FLAGS "-Iserial_communication:/home/jetson/snowblower/src/serial_communication/msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/jetson/snowblower/src/serial_communication/msg/ultrasonic_data.msg" NAME_WE)
add_custom_target(_serial_communication_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "serial_communication" "/home/jetson/snowblower/src/serial_communication/msg/ultrasonic_data.msg" ""
)
...
_generate_msg_cpp(serial_communication
  "/home/jetson/snowblower/src/serial_communication/msg/ultrasonic_data.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/serial_communication)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/serial_communication\")")
  # install generated code
  install(
