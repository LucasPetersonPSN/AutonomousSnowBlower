...
def main():
    ...
    left_image_pub = rospy.Publisher('/left/image_raw', Image, queue_size=1)
    right_image_pub = rospy.Publisher('/right/image_raw', Image, queue_size=1)
    left_info_pub = rospy.Publisher('/left/camera_info', CameraInfo, queue_size=1)
    right_info_pub = rospy.Publisher('/right/camera_info', CameraInfo, queue_size=1)
